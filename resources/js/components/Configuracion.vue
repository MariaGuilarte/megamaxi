                    ...
                    <div role="tabpanel" class="tab-pane active" id="account-vertical-general" aria-labelledby="account-pill-general" aria-expanded="true" v-for="userg in general" :key="userg.id">
                      <div class="media">
                        <a href="javascript: void(0);">
                          <img src="recursos/app-assets/images/portrait/small/avatar-s-12.jpg" class="rounded mr-75" alt="profile image" height="64" width="64">
                        </a>
                      ...
                      <form novalidate>
                        ...
                        <div class="col-12 d-flex flex-sm-row flex-column justify-content-end">
                          <button type="submit" class="btn btn-primary mr-sm-1 mb-1 mb-sm-0" @click="actualizargeneral()">Guardar Cambios</button>
...
actualizargeneral(){
  ...
  axios.put('/usuario/actualizarcambiosgeneral',{
    'idrol': this.general[0].idrol,
    'nombre': this.general[0].nombre,
    'apellido': this.general[0].apellido,
    'telefono': this.general[0].telefono,
    'direccion': this.general[0].direccion,
    'usuario': this.general[0].usuario,
